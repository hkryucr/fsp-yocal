...
user23 = User.create!(firstname: "Kylian", lastname: "Morel", password: "Morel123123", email: "Morel23@gmail.com", zipcode: "92128", birthday: Date.new(2000, 2, 10))
user24 = User.create!(firstname: "Nixon", lastname: "Wood", password: "NIXON23123", email: "kylian.morel@example.com", zipcode: "91118", birthday: Date.new(1990, 2, 3))
user25 = User.create!(firstname: "Jokubas", lastname: "Eidissen", password: "Eidissen23123", email: "SEidissen@gmail.com", zipcode: "92518", birthday: Date.new(2000, 1, 3))
user26 = User.create!(firstname: "Yasmine", lastname: "Faure", password: "EiFaure23123", email: "Faure@gmail.com", zipcode: "92518", birthday: Date.new(2000, 1, 3))
user25 = User.create!(firstname: "Madeleine", lastname: "Zhang", password: "EidisZhang123", email: "SEidiZhang@gmail.com", zipcode: "33518", birthday: Date.new(2000, 1, 3))
