        ...
        const form = (this.props.formType === 'Sign Up') ? (
            <form className="RS-form" onSubmit={this.handleSubmit(this.props.formType)}>
                ...
                <label htmlFor="password">
                    <div className="input-wrapper" tabIndex="0">
                        <input type="password" id="password" name="password" required onChange={this.update('password')} onChange={this.handPasswordClick} placeholder="Password" onClick={this.handPasswordClick}/>
                    </div>
